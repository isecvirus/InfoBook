function SortBy(dict, query, direction="forward"){
    ...
    $sorted = keys.sort(($1, $2) => { // start sorting ($1, $2) is comparing two values.
        if (dict[$1][query] < dict[$2][query]){ // check if $1 is before $2 (Ex):
        /*
        $1=abc
        $2=bcd
        ...
        */
        ...
        if (dict[$1][query] > dict[$2][query]){ // check if $1 is after $2 (Ex):
        /*
        $1=bcd
        $2=abc
